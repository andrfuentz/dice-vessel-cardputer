...
The recommended file is `release/dicevessel-v0.4-beta-factory.bin`.
...
esptool.py --chip esp32s3 --port COM3 --baud 460800 write_flash \
  ...
  0x0 release/dicevessel-v0.4-beta-factory.bin
```
...
O arquivo recomendado é `release/dicevessel-v0.4-beta-factory.bin`.
